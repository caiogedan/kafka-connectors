...
public class ReplicatorConnectorConfig extends AbstractConfig {
	...
	/*
	 * General Connector CONFIG Topics
	 */
	...
	public static final ConfigDef CONFIG = new ConfigDef()
			...
			.define(INCLUDE_MESSAGE_HEADERS_CONFIG, Type.BOOLEAN, INCLUDE_MESSAGE_HEADERS_DEFAULT, Importance.MEDIUM,
					INCLUDE_MESSAGE_HEADERS_DOC)
			...
			.define(SOURCE_BOOTSTRAP_SERVERS_CONFIG, Type.LIST, SOURCE_BOOTSTRAP_SERVERS_DEFAULT, Importance.HIGH,
					SOURCE_BOOTSTRAP_SERVERS_DOC)
			.define(CONSUMER_MAX_POLL_RECORDS_CONFIG, Type.INT, CONSUMER_MAX_POLL_RECORDS_DEFAULT, Importance.LOW,
					CONSUMER_MAX_POLL_RECORDS_DOC)
			.define(CONSUMER_AUTO_OFFSET_RESET_CONFIG, Type.STRING, CONSUMER_AUTO_OFFSET_RESET_DEFAULT,
					CONSUMER_AUTO_OFFSET_RESET_VALIDATOR, Importance.MEDIUM, CONSUMER_AUTO_OFFSET_RESET_DOC)
			.define(CONSUMER_KEY_DESERIALIZER_CONFIG, Type.STRING, CONSUMER_KEY_DESERIALIZER_DEFAULT, Importance.LOW,
